...
export const metadata: Metadata = {
  ...
  description:
    "Datenschutzerklärung von online-agency.ai – Informationen zur Erhebung, Verarbeitung und Nutzung personenbezogener Daten gemäß DSGVO und TDDDG.",
...
export default function DatenschutzPage() {
  return (
    <main>
      <div className="mx-auto max-w-4xl px-4 pb-24 pt-32 sm:px-6 sm:pt-36 lg:px-8">
        {/* Titel */}
        ...
        <section id="auf-einen-blick" className="mt-16 scroll-mt-28">
          <h2 className="font-mono text-2xl font-semibold text-signal-400">
            1. Datenschutz auf einen Blick
          </h2>
          <h3 className="font-mono mb-2 mt-8 text-lg font-semibold text-white">
            Allgemeine Hinweise
          </h3>
          ...
          <h4 className="font-mono mb-1.5 mt-5 text-base font-semibold text-white/85">
        ...
        <section
          id="hosting"
          className="mt-16 scroll-mt-28 border-t border-white/10 pt-12"
        >
          <h2 className="font-mono text-2xl font-semibold text-signal-400">
            2. Hosting
          </h2>
          ...
          <p className="mt-4 leading-relaxed text-white/60">
            Name des Anbieters: Vercel Inc.
            <br /> Adresse: 440 N Barranca Ave #4133, Covina, CA 91723, USA
            <br /> Website:{" "}
            <a
              href="https://vercel.com"
              target="_blank"
              rel="noopener noreferrer"
              className="text-signal-400 hover:text-signal-300 hover:underline"
            >
              https://vercel.com
            </a>
            <br /> Datenschutzerklärung von Vercel:{" "}
            <a
        ...
        >
          ...
          <div className="my-8 rounded-lg border border-signal-500/30 bg-signal-500/10 p-5">
            <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-signal-400">
              Wichtiger Hinweis · Widerspruchsrecht nach Art. 21 DSGVO
            </p>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 leading-relaxed text-white/60 marker:text-signal-500">
            <li>
          ...
          <p className="leading-relaxed text-white/60">
            ...
            <span className="font-mono text-white">http://</span> auf{" "}
            <span className="font-mono text-white">https://</span> wechselt und
        ...
        >
          ...
          <p className="leading-relaxed text-white/60">
            Wir nutzen KI-gestützte Dienste und / oder Anwendungen auf unserer
            Website.
          </p>
          <p className="mt-4 leading-relaxed text-white/60">
            Wir setzen Künstliche Intelligenz (KI) auf unserer Website wie folgt
            ein:
          </p>
          <p className="mt-4 leading-relaxed text-white/60">
            Verarbeitung und Automatisierung von Kontaktformular-Anfragen sowie
            Kundenanfragen mittels KI-Schnittstellen (OpenAI API / Make).
          </p>
          <p className="mt-4 leading-relaxed text-white/60">
            Wenn Sie auf unserer Website mit Elementen interagieren oder in
            Berührung kommen, in denen künstliche Intelligenz zu Einsatz kommt
            (z. B. Chatbot), werden Ihre Eingaben inklusive Metadaten
            verarbeitet, um eine passende Antwort oder Reaktion zu generieren.
          </p>
          <p className="mt-4 leading-relaxed text-white/60">
            Die Nutzung dieser KI-gestützten Funktionen erfolgt auf Grundlage von
            Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse
            daran, moderne Technologien auf unserer Website einzusetzen, um
            unsere Leistungen und Services zu verbessern und um neue
            Potenziale aus der Interaktion mit unseren Kunden zu erkennen. Falls
            eine Einwilligung erforderlich ist, erfolgt die Verarbeitung
            ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und §
            25 Abs. 1 TDDDG. Ihre Einwilligung können Sie jederzeit
            widerrufen.
          </p>
          <p className="mt-4 leading-relaxed text-white/60">
            Weitere Informationen zur Datenverarbeitung dieses Tools oder
            Dienstes erhalten Sie an der entsprechenden Stelle in dieser
            Datenschutzerklärung.
          </p>
          <h3 className="font-mono mb-2 mt-8 text-lg font-semibold text-white">
            Einsatz von Künstlicher Intelligenz (KI) zur Beantwortung von
            Kundenanfragen
          </h3>
          <p className="leading-relaxed text-white/60">
            Wir setzen KI-gestützte Software zur Bearbeitung und Beantwortung
            von Kundenanfragen ein. Dabei analysiert die von uns eingesetzte KI
            den Inhalt Ihrer Nachricht, um autonom oder teilweise autonom eine
            passende Antwort bzw. einen Antwortvorschlag zu generieren. In diesem
            Zusammenhang verarbeitet unsere KI sämtliche Inhalte Ihrer
            Nachricht, inklusive Namen, E-Mail-Adressen, Kommunikationsinhalte
            oder technische Informationen (z. B. IP-Adressen,
            Geräteinformationen).
          </p>
          <p className="mt-4 leading-relaxed text-white/60">
            Die Verwendung der eingesetzten KI-Software erfolgt auf Grundlage von
            Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an
            einer möglichst effizienten Kundenkommunikation unter Einsatz
            moderner technischer Lösungen.
          </p>
          <p className="mt-4 leading-relaxed text-white/60">
          ...
          <p className="leading-relaxed text-white/60">
            Wir nutzen ChatGPT für unsere Kundenkommunikation. Anbieter ist die
            ...
            . Wenn Sie also Kontakt zu uns aufnehmen, können Ihre Anfragen
            inklusive Metadaten an die Server von ChatGPT übertragen und dort
            verarbeitet werden, um eine passende Antwort zu generieren.
          </p>
          <div className="my-6 rounded-lg border border-signal-500/30 bg-signal-500/10 p-5">
            <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-signal-400">
              Wichtiger Hinweis · Kein Modelltraining mit Ihren Daten
            </p>
            <p className="text-sm leading-relaxed text-white/70">
              Wir haben ChatGPT so eingestellt, dass die von uns an ChatGPT
              weitergeleiteten Daten{" "}
              <strong className="text-white">
                nicht zum Trainieren des ChatGPT-Algorithmus
              </strong>{" "}
              eingesetzt werden.
            </p>
          </div>
          ...
          <h5 className="font-mono mb-1.5 mt-4 text-sm font-semibold uppercase tracking-wide text-white/70">
            Auftragsverarbeitung
          </h5>
          <p className="leading-relaxed text-white/60">
            Wir haben einen Vertrag über Auftragsverarbeitung (AVV) zur Nutzung
          ...
          <h4 className="font-mono mb-1.5 mt-5 text-base font-semibold text-white/85">
            Make (Automatisierungs-Plattform)
          </h4>
          <p className="leading-relaxed text-white/60">
            Wir nutzen Make (Automatisierungs-Plattform) für unsere
            Kundenkommunikation. Anbieter ist Celonis Inc. (Make), 1 World Trade
            Center, 87th Floor, New York, NY 10007, USA. Wenn Sie also Kontakt
            zu uns aufnehmen, können Ihre Anfragen inklusive Metadaten an die
            Server dieses Anbieters übertragen und dort verarbeitet werden, um
